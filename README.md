...
- [ ] Explain what a token is used for.
      -- tokens are use to aunthenticate users on a server.

- [ ] What steps can you take in your web apps to keep your data secure?
      -- first of all we need to make secure routes to prevent anyone who don't have access to certain data.

- [ ] Describe how web servers work.
      -- a web sever processes incoming network request over HTTP, so web server is to store, process and deliver web pages to clients.
